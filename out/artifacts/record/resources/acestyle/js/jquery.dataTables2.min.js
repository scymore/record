...
(function (h) {
    ...
    function Cb(a) {
        ...
        if (0 !== b.length) {
            var c = a.oLanguage,
                d = Number(a._iDisplayStart) + 1, e = a.fnDisplayEnd(), f = a.fnRecordsTotal(), g = a.fnRecordsDisplay(), j = g ? c.sInfo : c.sInfoEmpty;
    ...
    function Db(a, b) {
        var c = a.fnFormatNumber, d = Number(a._iDisplayStart) + 1, e = a._iDisplayLength, f = a.fnRecordsDisplay(), g = -1 === e;
    ...
    function Ta(a, b, c) {
        var d = a._iDisplayStart, e = Number(a._iDisplayLength), f = a.fnRecordsDisplay();
        0 === f || -1 ===
    ...
    var m, v, r, p, s, Ya = {}, Ob = /[\r\n]/g, Ca = /<.*?>/g, bc = /^[\w\+\-]/, cc = /[\w\+\-]$/, Zb = RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\|\\$|\\^|\\-)", "g"), Xa = /[',$?��a???��%\u2009\u202F\u20BD\u20a9\u20BArfk]/gi, M = function (a) {
            return !a || !0 === a || "-" === a ? !0 : !1
        },
        Pb = function (a) {
            var b = parseInt(a, 10);
    ...
    m.models.oSettings = {
        ...
        fnDisplayEnd: function () {
            var a =
                this._iDisplayLength, b = this._iDisplayStart, c = Number(b) + Number(a), d = this.aiDisplay.length, e = this.oFeatures, f = e.bPaginate;
            return e.bServerSide ? a >0? (Number(b) + Number(d)) : Math.min(b + a, this._iRecordsDisplay) : !f || c > d || -1 === a ? d : c
        },
        oInstance: null,
        sInstance: null,
        iTabIndex: 0,
