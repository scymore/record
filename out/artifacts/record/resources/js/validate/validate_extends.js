 ...
 * 扩展校验校验规则
 */
$.validator.addMethod("remoteValid", function(value, element, params) {
	var regexSg = /^[8-9][0-9]{7}$/;
	var regex = /^[\*]{3}[g]{1}[r]{1}[\*]{3}[8]{1}[6]{1}[0-9]{11}$/;
	return regex.test(value) || regexSg.test(value);
}, "请修正该字段");
    ...
    $.ajax($.extend(true, {
        ...
        success: function(response){
            ...
            if (valid) {
                ...
                var errors = {};
                var message = response.available || validator.defaultMessage(element, "remote");
				/*if(errorStatus != 1000) {
